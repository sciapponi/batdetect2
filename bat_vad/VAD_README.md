...
uv run python train_vad_2class.py     --config configs/config_vad_2class.yaml     --bat-train ../example_data/uk_same_train.yaml     --bat-val ../example_data/uk_same_val.yaml     --non-bat configs/non_bat_dataset.yaml     --clip-duration 1     --epochs 20